 ...
 *
 */
package ec.app.gep.Earthquakes;
...
public class Earthquakes extends GEPProblem implements SimpleProblemForm 
{

 /* Number of earthquakes per year magnitude 7.0 or greater. 1900-1998. Source:

    National Earthquake Information Center.

    Original time series data file EARTHQ.DAT obtained from:

    Hyndman, R.J. (n.d.) Time Series Data Library, http://www.robhyndman.info/TSDL/. Accessed on June 3, 2006.

    For the integral time series used in this run, each value from original raw series was 
    replaced by its moving average using a smoothing period p = 10.
 */
