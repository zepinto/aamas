...
public class Majority extends GEPProblem implements SimpleProblemForm 
{
	// Attempt to discover the Majority function using and, or and not
	//
	// This looks at 3 boolean variables and determines if there are 2 or more true (1) values
