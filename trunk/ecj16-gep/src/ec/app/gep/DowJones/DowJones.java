...
public class DowJones extends GEPProblem implements SimpleProblemForm 
{

 /* Monthly closings of the Dow-Jones industrial index, Aug. 1968 - Aug. 1981. Source:

	Hipel and Mcleod (1994). Time Series Modelling of Water Resources and Environmental 
	Systems, Elsevier.

	Original time series data file DJ.DAT obtained from:

	Hyndman, R.J. (n.d.) Time Series Data Library, http://www.robhyndman.info/TSDL/. 
	Accessed on June 3, 2006.

	For the integral time series used in this run, each value from the original raw 
